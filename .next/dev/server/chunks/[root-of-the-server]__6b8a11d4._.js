...
async function POST(request) {
    try {
        ...
        const { data, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["supabase"].from('quotes').insert(quoteInsert).select().single();
        if (error) {
        ...
        try {
            ...
            if (!process.env.RESEND_API_KEY) {
                ...
                const servicesList = quoteData.selectedServices?.length > 0 ? quoteData.selectedServices.join(', ') : quoteData.customService || 'N/A';
...
async function GET(request) {
    try {
        ...
        let query = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["supabase"].from('quotes').select('*').order('created_at', {
            ascending: false
        });
...
//# sourceMappingURL=%5Broot-of-the-server%5D__6b8a11d4._.js.map