...
"[project]/src/services/supabaseServiceData.ts [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
const getServiceCategories = async ()=>{
    try {
        // Fetch categories
        const { data: categories, error: categoriesError } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].from('service_categories').select('*').eq('is_active', true).order('display_order', {
            ascending: true
        });
        if (categoriesError) {
        ...
        // Fetch all items
        const { data: items, error: itemsError } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].from('service_items').select('*').eq('is_active', true).order('display_order', {
            ascending: true
        });
        if (itemsError) {
...
const getCategoryById = async (categoryId)=>{
    try {
        const { data: category, error: categoryError } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].from('service_categories').select('*').eq('id', categoryId).eq('is_active', true).single();
        if (categoryError) {
            console.error('Error fetching category:', categoryError);
            return null;
        }
        const { data: items, error: itemsError } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].from('service_items').select('*').eq('category_id', categoryId).eq('is_active', true).order('display_order', {
            ascending: true
        });
        if (itemsError) {
...
const getServiceItemById = async (itemId)=>{
    try {
        const { data: item, error: itemError } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].from('service_items').select('*, service_categories(*)').eq('id', itemId).eq('is_active', true).single();
        if (itemError || !item) {
        ...
        const { data: categoryItems, error: categoryItemsError } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].from('service_items').select('*').eq('category_id', itemRow.category_id).eq('is_active', true);
...
const calculateTotalPrice = async (selectedItemIds, urgency, propertyType)=>{
    try {
        ...
        const { data: items, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].from('service_items').select('unit_price').in('id', selectedItemIds).eq('is_active', true);
        if (error) {
...
const calculateTotalDuration = async (selectedItemIds)=>{
    try {
        let totalDuration = 0;
        const { data: items, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].from('service_items').select('estimated_duration').in('id', selectedItemIds).eq('is_active', true);
        if (error) {
...
const createServiceCategory = async (category)=>{
    try {
        const { data, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].from('service_categories').insert({
            id: category.id,
            name: category.name,
...
const createServiceItem = async (categoryId, item)=>{
    try {
        const { data, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].from('service_items').insert({
            id: item.id,
...
const updateServiceCategory = async (categoryId, updates)=>{
    try {
        ...
        const { data, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].from('service_categories').update(updateData).eq('id', categoryId).select().single();
        if (error) {
            console.error('Error updating service category:', error);
            return null;
        }
        // Fetch items for the updated category
        const { data: items } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].from('service_items').select('*').eq('category_id', categoryId).eq('is_active', true);
...
const updateServiceItem = async (itemId, updates)=>{
    try {
        ...
        if (updates.estimatedDuration !== undefined) updateData.estimated_duration = updates.estimatedDuration;
        if (updates.displayOrder !== undefined) updateData.display_order = updates.displayOrder;
        const { data, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].from('service_items').update(updateData).eq('id', itemId).select().single();
        if (error) {
...
const deleteServiceCategory = async (categoryId)=>{
    try {
        const { error } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].from('service_categories').update({
            is_active: false
        }).eq('id', categoryId);
        if (error) {
...
const deleteServiceItem = async (itemId)=>{
    try {
        const { error } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].from('service_items').update({
            is_active: false
        }).eq('id', itemId);
        if (error) {
...
"[project]/src/services/supabaseQuoteService.ts [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/lib/supabase.ts [app-ssr] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$supabaseServiceData$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/services/supabaseServiceData.ts [app-ssr] (ecmascript)");
;
;
const submitQuoteToSupabase = async (quoteData)=>{
    try {
        ...
        const estimatedPrice = quoteData.estimatedPrice || await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$supabaseServiceData$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["calculateTotalPrice"])(quoteData.selectedServices, quoteData.urgency, quoteData.propertyType);
        const estimatedDuration = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$supabaseServiceData$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["calculateTotalDuration"])(quoteData.selectedServices);
        ...
        const { data, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].from('quotes').insert(quoteInsert).select().single();
        if (error) {
...
const getQuoteById = async (quoteId)=>{
    try {
        const { data, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].from('quotes').select('*').eq('quote_id', quoteId).single();
        if (error) {
...
const getAllQuotes = async ()=>{
    try {
        const { data, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].from('quotes').select('*').order('created_at', {
            ascending: false
        });
        if (error) {
...
const updateQuoteStatus = async (quoteId, status)=>{
    try {
        const { data, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].from('quotes').update({
            status
...
const uploadPhotosToSupabase = async (files)=>{
    try {
        ...
        for (const file of files){
            ...
            const { data, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].storage.from('quotes').upload(filePath, file);
            if (error) {
                console.error('Error uploading photo:', error);
                continue;
            }
            // Get public URL
            const { data: publicUrlData } = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].storage.from('quotes').getPublicUrl(filePath);
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$supabaseQuoteService$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/services/supabaseQuoteService.ts [app-ssr] (ecmascript)");
...
const useQuoteForm = ()=>{
    ...
    const calculateEstimate = async ()=>{
        try {
            ...
            const estimate = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$supabaseServiceData$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["calculateTotalPrice"])(formData.selectedServices, formData.urgency, formData.propertyType);
            updateFormData({
    ...
    const handleSubmit = async ()=>{
        ...
        try {
            ...
            try {
                const response = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$supabaseQuoteService$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["submitQuoteToSupabase"])({
                    ...formData,
                    status: 'submitted'
                });
...
"[project]/src/components/forms/ServiceSelectorTwoTier.tsx [app-ssr] (ecmascript)", ((__turbopack_context__, module, exports) => {
...
"[project]/src/components/forms/PropertyInfo.tsx [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
const QuoteEstimate = ({ quoteData })=>{
    const [selectedServiceDetails, setSelectedServiceDetails] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])([]);
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        const fetchServiceDetails = async ()=>{
            ...
            try {
                ...
                const detailsPromises = quoteData.selectedServices.map((id)=>(0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$supabaseServiceData$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["getServiceItemById"])(id));
                ...
                if (validDetails.length > 0) {
                    ...
                    const staticDetails = quoteData.selectedServices.map((id)=>(0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$serviceData$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["getServiceItemById"])(id)).filter(Boolean);
                    setSelectedServiceDetails(staticDetails);
                }
                // Calculate duration
                const duration = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$supabaseServiceData$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["calculateTotalDuration"])(quoteData.selectedServices);
                setTotalDuration(duration || (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$serviceData$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["calculateTotalDuration"])(quoteData.selectedServices));
            } catch (error) {
                console.error('Error fetching service details:', error);
                // Fallback to static data
                const staticDetails = quoteData.selectedServices.map((id)=>(0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$serviceData$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["getServiceItemById"])(id)).filter(Boolean);
                setSelectedServiceDetails(staticDetails);
                setTotalDuration((0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$serviceData$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["calculateTotalDuration"])(quoteData.selectedServices));
            } finally{
                setIsLoading(false);
            }
        };
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$forms$2f$PropertyInfo$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/components/forms/PropertyInfo.tsx [app-ssr] (ecmascript)");
...
;
const QuoteForm = ()=>{
    const { formData, currentStep, isSubmitting, error, updateFormData, handleNextStep, handlePreviousStep, handleSubmit } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$viewmodels$2f$useQuoteForm$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useQuoteForm"])();
    const totalSteps = 6;
    ...
    const renderStep = ()=>{
        switch(currentStep){
            ...
            case 2:
                return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$forms$2f$PropertyInfo$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"], {
...
//# sourceMappingURL=_fecd5e01._.js.map