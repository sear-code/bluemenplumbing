...
"[project]/src/services/supabaseServiceData.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
;
/**
 * Transform database row to ServiceCategory model
 */ const transformCategoryRow = (row, items)=>{
    return {
        id: row.id,
        name: row.name,
        ...
        icon: row.icon,
        priceRangeMin: Number(row.price_range_min),
        priceRangeMax: Number(row.price_range_max),
        estimatedDuration: row.estimated_duration,
        displayOrder: row.display_order,
        items: items.filter((item)=>item.category_id === row.id).map(transformItemRow).sort((a, b)=>a.displayOrder - b.displayOrder)
    };
};
/**
 * Transform database row to ServiceItem model
 */ const transformItemRow = (row)=>{
    return {
        id: row.id,
        name: row.name,
        ...
        partsPrice: row.parts_price ? Number(row.parts_price) : undefined,
        estimatedDuration: row.estimated_duration,
        displayOrder: row.display_order
    };
};
const getServiceCategories = async ()=>{
    try {
        // Fetch categories
        const { data: categories, error: categoriesError } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from('service_categories').select('*').eq('is_active', true).order('display_order', {
            ascending: true
        });
        if (categoriesError) {
        ...
        // Fetch all items
        const { data: items, error: itemsError } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from('service_items').select('*').eq('is_active', true).order('display_order', {
            ascending: true
        });
        if (itemsError) {
        ...
        const serviceCategories = (categories || []).map((category)=>transformCategoryRow(category, items));
...
const getCategoryById = async (categoryId)=>{
    try {
        const { data: category, error: categoryError } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from('service_categories').select('*').eq('id', categoryId).eq('is_active', true).single();
        if (categoryError) {
            console.error('Error fetching category:', categoryError);
            return null;
        }
        const { data: items, error: itemsError } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from('service_items').select('*').eq('category_id', categoryId).eq('is_active', true).order('display_order', {
            ascending: true
        });
        if (itemsError) {
        ...
        return transformCategoryRow(category, items);
    } catch (error) {
        console.error('Error in getCategoryById:', error);
        return null;
    }
};
const getServiceItemById = async (itemId)=>{
    try {
        const { data: item, error: itemError } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from('service_items').select('*, service_categories(*)').eq('id', itemId).eq('is_active', true).single();
        if (itemError || !item) {
            console.error('Error fetching service item:', itemError);
            return null;
        }
        const itemRow = item;
        // Get all items for this category
        const { data: categoryItems, error: categoryItemsError } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from('service_items').select('*').eq('category_id', itemRow.category_id).eq('is_active', true);
        if (categoryItemsError) {
            console.error('Error fetching category items:', categoryItemsError);
            return null;
        }
        const category = transformCategoryRow(itemRow.service_categories, categoryItems);
        const serviceItem = transformItemRow(itemRow);
        return {
            category,
            item: serviceItem
        };
    } catch (error) {
        console.error('Error in getServiceItemById:', error);
        return null;
    }
};
const calculateTotalPrice = async (selectedItemIds, urgency, propertyType)=>{
    try {
        let baseTotal = 0;
        // Fetch all selected items
        const { data: items, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from('service_items').select('unit_price').in('id', selectedItemIds).eq('is_active', true);
        if (error) {
        ...
        items?.forEach((item)=>{
            baseTotal += Number(item.unit_price);
        });
...
const calculateTotalDuration = async (selectedItemIds)=>{
    try {
        let totalDuration = 0;
        const { data: items, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from('service_items').select('estimated_duration').in('id', selectedItemIds).eq('is_active', true);
        if (error) {
...
const createServiceCategory = async (category)=>{
    try {
        const { data, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from('service_categories').insert({
            id: category.id,
            name: category.name,
            description: category.description,
            category: category.category,
            icon: category.icon,
            price_range_min: category.priceRangeMin,
            price_range_max: category.priceRangeMax,
            estimated_duration: category.estimatedDuration,
...
const createServiceItem = async (categoryId, item)=>{
    try {
        const { data, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from('service_items').insert({
            id: item.id,
            category_id: categoryId,
            name: item.name,
            description: item.description || null,
            unit_price: item.unitPrice,
            parts_extra: item.partsExtra,
            parts_price: item.partsPrice || null,
        ...
        return transformItemRow(data);
    } catch (error) {
        console.error('Error in createServiceItem:', error);
        return null;
    }
};
const updateServiceCategory = async (categoryId, updates)=>{
    try {
        const updateData = {};
        ...
        if (updates.priceRangeMin !== undefined) updateData.price_range_min = updates.priceRangeMin;
        if (updates.priceRangeMax !== undefined) updateData.price_range_max = updates.priceRangeMax;
        if (updates.estimatedDuration !== undefined) updateData.estimated_duration = updates.estimatedDuration;
        if (updates.displayOrder !== undefined) updateData.display_order = updates.displayOrder;
        const { data, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from('service_categories').update(updateData).eq('id', categoryId).select().single();
        if (error) {
            console.error('Error updating service category:', error);
            return null;
        }
        // Fetch items for the updated category
        const { data: items } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from('service_items').select('*').eq('category_id', categoryId).eq('is_active', true);
        return transformCategoryRow(data, items || []);
    } catch (error) {
...
const updateServiceItem = async (itemId, updates)=>{
    try {
        ...
        if (updates.partsExtra !== undefined) updateData.parts_extra = updates.partsExtra;
        if (updates.partsPrice !== undefined) updateData.parts_price = updates.partsPrice;
        if (updates.estimatedDuration !== undefined) updateData.estimated_duration = updates.estimatedDuration;
        if (updates.displayOrder !== undefined) updateData.display_order = updates.displayOrder;
        const { data, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from('service_items').update(updateData).eq('id', itemId).select().single();
        if (error) {
...
const deleteServiceCategory = async (categoryId)=>{
    try {
        const { error } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from('service_categories').update({
            is_active: false
        }).eq('id', categoryId);
        if (error) {
...
const deleteServiceItem = async (itemId)=>{
    try {
        const { error } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from('service_items').update({
            is_active: false
        }).eq('id', itemId);
        if (error) {
        ...
        console.error('Error in deleteServiceItem:', error);
        return false;
    }
};
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
...
"[project]/src/services/supabaseQuoteService.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/lib/supabase.ts [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$supabaseServiceData$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/services/supabaseServiceData.ts [app-client] (ecmascript)");
;
;
const submitQuoteToSupabase = async (quoteData)=>{
    try {
        const quoteId = `BMP-${Date.now()}`;
        const validUntil = new Date();
        validUntil.setDate(validUntil.getDate() + 30);
        // Calculate estimated price and duration if not provided
        const estimatedPrice = quoteData.estimatedPrice || await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$supabaseServiceData$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["calculateTotalPrice"])(quoteData.selectedServices, quoteData.urgency, quoteData.propertyType);
        const estimatedDuration = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$supabaseServiceData$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["calculateTotalDuration"])(quoteData.selectedServices);
        // Prepare quote data for Supabase
        const quoteInsert = {
            quote_id: quoteId,
            customer_first_name: quoteData.customerInfo.firstName,
            customer_last_name: quoteData.customerInfo.lastName,
            ...
            address_street: quoteData.address.street,
            address_city: quoteData.address.city,
            address_state: quoteData.address.state,
            address_zip_code: quoteData.address.zipCode,
            urgency: quoteData.urgency,
            problem_description: quoteData.problemDescription,
            ...
            preferred_date_time: quoteData.preferredDateTime || null,
            estimated_price: estimatedPrice,
            estimated_duration: estimatedDuration,
            status: 'submitted'
        };
        // Insert quote into Supabase
        const { data, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from('quotes').insert(quoteInsert).select().single();
        if (error) {
...
const getQuoteById = async (quoteId)=>{
    try {
        const { data, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from('quotes').select('*').eq('quote_id', quoteId).single();
        if (error) {
...
const getAllQuotes = async ()=>{
    try {
        const { data, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from('quotes').select('*').order('created_at', {
            ascending: false
        });
        if (error) {
...
const updateQuoteStatus = async (quoteId, status)=>{
    try {
        const { data, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from('quotes').update({
            status
...
const uploadPhotosToSupabase = async (files)=>{
    try {
        const uploadedUrls = [];
        for (const file of files){
            const fileName = `${Date.now()}-${file.name}`;
            const filePath = `quote-photos/${fileName}`;
            const { data, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].storage.from('quotes').upload(filePath, file);
            if (error) {
                console.error('Error uploading photo:', error);
                continue;
            }
            // Get public URL
            const { data: publicUrlData } = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].storage.from('quotes').getPublicUrl(filePath);
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$supabaseQuoteService$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/services/supabaseQuoteService.ts [app-client] (ecmascript)");
...
const useQuoteForm = ()=>{
    ...
    const calculateEstimate = async ()=>{
        try {
            // Try to calculate using Supabase service first
            const estimate = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$supabaseServiceData$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["calculateTotalPrice"])(formData.selectedServices, formData.urgency, formData.propertyType);
            updateFormData({
            ...
            console.warn('Using fallback price calculation:', error);
    ...
    const handleSubmit = async ()=>{
        ...
        try {
            ...
            const hasOnlyCustomService = formData.selectedServices.length === 0 && formData.customService && formData.customService.trim().length > 0;
            // Submit quote to Supabase (with fallback to original service)
            try {
                const response = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$supabaseQuoteService$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["submitQuoteToSupabase"])({
                    ...formData,
                    status: 'submitted'
                });
                ...
                // Fallback to original quote service
...
_s(useQuoteForm, "GxrKzgD1wM2xmjqUd6PSWCxPypE=");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
...
"[project]/src/components/forms/ServiceSelectorTwoTier.tsx [app-client] (ecmascript)", ((__turbopack_context__, module, exports) => {

const e = new Error("Could not parse module '[project]/src/components/forms/ServiceSelectorTwoTier.tsx'\n\nUnexpected token. Did you mean `{'}'}` or `&rbrace;`?");
...
;
;
const ProblemDetails = ({ description, photos = [], onUpdate })=>{
    _s();
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                children: [
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                        ...
                        children: "Please provide as much detail as possible about your plumbing issue"
                    }, void 0, false, {
                        fileName: "[project]/src/components/forms/ProblemDetails.tsx",
                        lineNumber: 49,
                        columnNumber: 9
...
_s(ProblemDetails, "ACYOl9OrK5NjoDTk2FFOGWKDMew=");
_c = ProblemDetails;
const __TURBOPACK__default__export__ = ProblemDetails;
var _c;
__turbopack_context__.k.register(_c, "ProblemDetails");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
...
"[project]/src/components/forms/PropertyInfo.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
;
;
const PropertyInfo = ({ propertyType, address, onUpdate })=>{
        ...
        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
            children: [
                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("h2", {
                    ...
                    fileName: "[project]/src/components/forms/PropertyInfo.tsx",
                    lineNumber: 36,
                    columnNumber: 9
                }, ("TURBOPACK compile-time value", void 0)),
                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                    className: "text-gray-600 mb-6",
                    children: "Tell us about your property type and location"
                }, void 0, false, {
                    fileName: "[project]/src/components/forms/PropertyInfo.tsx",
                    lineNumber: 39,
                    columnNumber: 9
...
_s(ContactInfo, "hioHydcPcyW8tAx4nU9j+LkN6+o=");
_c = ContactInfo;
...
const QuoteEstimate = ({ quoteData })=>{
    _s();
    const [selectedServiceDetails, setSelectedServiceDetails] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])([]);
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "QuoteEstimate.useEffect": ()=>{
            const fetchServiceDetails = {
                "QuoteEstimate.useEffect.fetchServiceDetails": async ()=>{
                    setIsLoading(true);
                    try {
                        // Fetch service details from Supabase
                        const detailsPromises = quoteData.selectedServices.map({
                            "QuoteEstimate.useEffect.fetchServiceDetails.detailsPromises": (id)=>(0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$supabaseServiceData$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getServiceItemById"])(id)
                        }["QuoteEstimate.useEffect.fetchServiceDetails.detailsPromises"]);
                        const details = await Promise.all(detailsPromises);
                        const validDetails = details.filter({
                            "QuoteEstimate.useEffect.fetchServiceDetails.validDetails": (d)=>d !== null
                        }["QuoteEstimate.useEffect.fetchServiceDetails.validDetails"]);
                        if (validDetails.length > 0) {
                            setSelectedServiceDetails(validDetails);
                        } else {
                            // Fallback to static data
                            const staticDetails = quoteData.selectedServices.map({
                                "QuoteEstimate.useEffect.fetchServiceDetails.staticDetails": (id)=>(0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$serviceData$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getServiceItemById"])(id)
                            }["QuoteEstimate.useEffect.fetchServiceDetails.staticDetails"]).filter(Boolean);
                            setSelectedServiceDetails(staticDetails);
                        }
                        // Calculate duration
                        const duration = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$supabaseServiceData$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["calculateTotalDuration"])(quoteData.selectedServices);
                        setTotalDuration(duration || (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$serviceData$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["calculateTotalDuration"])(quoteData.selectedServices));
                    } catch (error) {
                        ...
                        setSelectedServiceDetails(staticDetails);
                        setTotalDuration((0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$serviceData$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["calculateTotalDuration"])(quoteData.selectedServices));
                    } finally{
                        setIsLoading(false);
                    }
                }
            }["QuoteEstimate.useEffect.fetchServiceDetails"];
            fetchServiceDetails();
        }
    }["QuoteEstimate.useEffect"], [
        ...
        return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
            ...
            children: [
                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$lucide$2d$react$2f$dist$2f$esm$2f$icons$2f$loader$2d$circle$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__default__as__Loader2$3e$__["Loader2"], {
                    className: "w-8 h-8 animate-spin text-[#4492AC]"
                }, void 0, false, {
                ...
                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                    ...
                    children: "Calculating your estimate..."
                }, void 0, false, {
                    fileName: "[project]/src/components/forms/QuoteEstimate.tsx",
                    lineNumber: 75,
                    columnNumber: 9
                        ...
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            ...
                            children: [
                                ...
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                    ...
                                    children: quoteData.estimatedPrice || 0
                                }, void 0, false, {
                                    fileName: "[project]/src/components/forms/QuoteEstimate.tsx",
                                    lineNumber: 97,
                                    columnNumber: 13
...
_s(QuoteEstimate, "FJSl9D4KoEE10eqbRQxBYWMToys=");
_c = QuoteEstimate;
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$forms$2f$PropertyInfo$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/components/forms/PropertyInfo.tsx [app-client] (ecmascript)");
...
const QuoteForm = ()=>{
    _s();
    const { formData, currentStep, isSubmitting, error, updateFormData, handleNextStep, handlePreviousStep, handleSubmit } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$viewmodels$2f$useQuoteForm$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useQuoteForm"])();
    const totalSteps = 6;
    ...
    const renderStep = ()=>{
        switch(currentStep){
            ...
            case 2:
                return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$forms$2f$PropertyInfo$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"], {
            ...
            case 5:
                const isCustomOnly = formData.selectedServices.length === 0 && formData.customService && formData.customService.trim().length > 0;
    ...
    const getButtonIcon = ()=>{
        if (currentStep === 4) return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$lucide$2d$react$2f$dist$2f$esm$2f$icons$2f$circle$2d$check$2d$big$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__default__as__CheckCircle$3e$__["CheckCircle"], {
...
_s(QuoteForm, "Sy1TcVI7n8r5N6Gpf5RKLOAgp1I=", false, function() {
    return [
                ...
                children: [
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        ...
                        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            ...
                            children: [
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                    className: "bg-[#4492AC] rounded-2xl p-8 md:p-12 text-center shadow-xl",
                                    children: [
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("h3", {
                                        ...
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                            className: "text-blue-50 text-lg mb-8 max-w-2xl mx-auto",
                                        ...
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                            className: "text-blue-50 text-sm mt-6",
                                            children: [
                                ...
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                    ...
                                    children: [
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                            ...
                                            children: [
                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                    className: "w-10 h-10 bg-[#4492AC] rounded-full flex items-center justify-center flex-shrink-0",
                                                    children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$lucide$2d$react$2f$dist$2f$esm$2f$icons$2f$clock$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__default__as__Clock$3e$__["Clock"], {
                                                ...
                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                    children: [
                                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("h3", {
                                                            ...
                                                            children: t('quote.feature1.title', 'Fast Response')
                                                        }, void 0, false, {
                                                            fileName: "[project]/src/components/QuoteGenerator.tsx",
                                                            lineNumber: 88,
                                                            columnNumber: 21
                                                        ...
                                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                                            className: "text-sm text-gray-600",
                                                            children: "Finalize the quote in less than 24 hours"
                                                        }, void 0, false, {
                                                            fileName: "[project]/src/components/QuoteGenerator.tsx",
                                                            lineNumber: 91,
                                                            columnNumber: 21
                                            ...
                                            children: [
                                                ...
                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                    children: [
                                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("h3", {
                                                            className: "text-lg font-semibold text-gray-900 mb-1",
                                                            children: t('quote.feature2.title', 'Detailed Estimates')
                                                        }, void 0, false, {
                                                            fileName: "[project]/src/components/QuoteGenerator.tsx",
                                                            lineNumber: 102,
                                                            columnNumber: 21
                                                        ...
                                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                                            className: "text-sm text-gray-600",
                                                            children: t('quote.feature2.description', 'Transparent pricing with no hidden fees')
                                                        }, void 0, false, {
                                                            fileName: "[project]/src/components/QuoteGenerator.tsx",
                                                            lineNumber: 105,
                                                            columnNumber: 21
                                            ...
                                            children: [
                                                ...
                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                    children: [
                                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("h3", {
                                                            className: "text-lg font-semibold text-gray-900 mb-1",
                                                            children: t('quote.feature3.title', 'No Obligation')
                                                        }, void 0, false, {
                                                            fileName: "[project]/src/components/QuoteGenerator.tsx",
                                                            lineNumber: 116,
                                                            columnNumber: 21
                                                        ...
                                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                                            className: "text-sm text-gray-600",
                                                            children: t('quote.feature3.description', 'Free quotes with no commitment required')
                                                        }, void 0, false, {
                                                            fileName: "[project]/src/components/QuoteGenerator.tsx",
                                                            lineNumber: 119,
                                                            columnNumber: 21
        ...
        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
            ...
            children: [
                                ...
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                    ...
                                    children: [
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                            ...
                                            children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                className: "p-2 rounded-full bg-[#045372] backdrop-blur-sm mr-3",
                                        ...
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("h3", {
                                            className: "text-xl font-bold mb-2 group-hover:text-[#94E2FC] transition-colors",
                ...
                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                    ...
                    children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        className: "flex space-x-4 w-max px-4",
                        children: services.map((service, index)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("section", {
        ...
        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
            ...
            children: [
                ...
                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                    className: "mt-16 bg-[#4492AC] backdrop-blur-sm rounded-2xl p-8 shadow-elegant",
                    children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
...
const Footer = ()=>{
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("footer", {
        className: "bg-[#4492AC] text-white py-8",
        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
            className: "container mx-auto px-4",
            children: [
                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        ...
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            children: [
                                ...
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                    ...
                                    children: "Your trusted local plumbing experts with over 15 years of professional service."
                                }, void 0, false, {
                                    fileName: "[project]/src/components/Footer.tsx",
                                    lineNumber: 22,
                                    columnNumber: 13
                                ...
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                    ...
                                    children: "Licensed, insured, and available 24/7 for all your plumbing needs."
                                }, void 0, false, {
                                    fileName: "[project]/src/components/Footer.tsx",
                                    lineNumber: 25,
                                    columnNumber: 13
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        ...
        children: [
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("section", {
                className: "bg-[#94E2FC] py-6 mt-16 md:hidden",
                children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                    className: "container mx-auto px-4",
                    children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("h2", {
                        className: "text-2xl md:text-3xl lg:text-4xl font-bold text-center text-white",
                        style: {
                            textShadow: '1px 1px 4px rgba(68, 146, 172, 0.6), -1px -1px 2px rgba(68, 146, 172, 0.4)'
                        },
                        children: "Why Pay More, When You Can Pay Less!"
                    }, void 0, false, {
                        fileName: "[project]/app/page.tsx",
                        lineNumber: 19,
                        columnNumber: 11
...
//# sourceMappingURL=_82b98bec._.js.map